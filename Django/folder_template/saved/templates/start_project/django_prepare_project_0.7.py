...
def create_a_django_project_and_app(project_name, app_name, virtual_env, requirements_file):
    if os.path.exists (virtual_env) or True:
...
if __name__ == '__main__':        
    ...
    parser.add_argument ('-n', "--new", help="Create new project , new app.", type=str) # e.g: python3 django_prepare_project_0.7.py --new new
