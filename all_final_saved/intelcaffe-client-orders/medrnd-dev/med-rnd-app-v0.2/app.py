...
def get_todolist():
    ...
    controlled_gfr_less_than_40 = int (content[6].split (' ')[1])
    controlled_age_less_than_75 = int (content[7].split (' ')[1])
    ...
    generic_gfr_less_than_40 = int (content[6].split (' ')[2])
    generic_age_less_than_75 = int (content[7].split (' ')[2])
    ...
    gfr_less_than_40_data = Todo (name='GFR Less Than 40', controlled=controlled_gfr_less_than_40, generic=generic_gfr_less_than_40)
    age_less_than_75_data = Todo (name='Age Less Than 75', controlled=controlled_age_less_than_75, generic=generic_age_less_than_75)

    todo_list = [diabetes_data, chronic_kidney_disease_data, anemia_data, heart_failure_data, gfr_less_than_40_data, age_less_than_75_data]
...
def delete():
    ...
    if last_record_map['category'] == 'RIPC':
        ...
        generic_gfr_less_than_40 = generic_gfr_less_than_40 - int (last_record_map.get('gfr_less_than_40', 0))
        generic_age_less_than_75 = generic_age_less_than_75 - int (last_record_map.get('age_less_than_75', 0))
        ...
        controlled_gfr_less_than_40 = controlled_gfr_less_than_40 - int (last_record_map.get('gfr_less_than_40', 0))
        controlled_age_less_than_75 = controlled_age_less_than_75 - int (last_record_map.get('age_less_than_75', 0))
    ...
    replace_line (file_name='total_count.txt', line_num=6, text='gfr_less_than_40 ' + str (controlled_gfr_less_than_40) + ' ' + str (generic_gfr_less_than_40) + '\n')
    replace_line (file_name='total_count.txt', line_num=7, text='age_less_than_75 ' + str (controlled_age_less_than_75) + ' ' + str (generic_age_less_than_75) + '\n')
...
def add():
    ...
    gfr_less_than_40 = request.form.get ("gfr_less_than_40")
    age_less_than_75 = request.form.get ("age_less_than_75")

    if gfr_less_than_40 == 'gfr_less_than_40':
        gfr_less_than_40 = 1
    else:
        gfr_less_than_40 = 0

    if age_less_than_75 == 'age_less_than_75':
        age_less_than_75 = 1
    else:
        age_less_than_75 = 0
    ...
    print (heart_failure, anemia, chronic_kidney_disease, diabetes, gfr_less_than_40, age_less_than_75)

    if heart_failure == 0 and anemia == 0 and chronic_kidney_disease == 0 and diabetes == 0 and gfr_less_than_40 == 0 and age_less_than_75 == 0:
        todo_list, total_patient = get_todolist ()
        return render_template ("index.html", total_patient=total_patient, todo_list=todo_list, category_list=[])
    ...
    if gfr_less_than_40:
        total_diff_if_controlled += 1 + controlled_gfr_less_than_40 - generic_gfr_less_than_40

    if age_less_than_75:
        total_diff_if_controlled += 1 + controlled_age_less_than_75 - generic_age_less_than_75
    ...
    if gfr_less_than_40:
        total_diff_if_generic += 1 - controlled_gfr_less_than_40 + generic_gfr_less_than_40

    if age_less_than_75:
        total_diff_if_generic += 1 - controlled_age_less_than_75 + generic_age_less_than_75
    ...
    if total_diff_if_controlled <= total_diff_if_generic:
        ...
        if gfr_less_than_40:
            controlled_gfr_less_than_40 += 1

        if age_less_than_75:
            controlled_age_less_than_75 += 1
        ...
        if gfr_less_than_40:
            generic_gfr_less_than_40 += 1

        if age_less_than_75:
            generic_age_less_than_75 += 1
    ...
    print (str (time_stamp), 'diabetes: ' + str (diabetes), \
           ...
           'category: ' + category, \
           'gfr_less_than_40: ' + str(gfr_less_than_40), \
           'age_less_than_75: ' + str(age_less_than_75), \
           file=open ('record.txt', 'a'))
